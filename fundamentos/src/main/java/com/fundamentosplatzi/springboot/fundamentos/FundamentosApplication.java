...
public class FundamentosApplication implements CommandLineRunner {
	...
	private void saveUsersInDatabase(){
		...
		User user5 = new User("Test1", "Test1@domain.com", LocalDate.of(2021, 11,11));
		User user6 = new User("Test2", "Test2@domain.com", LocalDate.of(2021, 2,25));
		User user7 = new User("Test3", "Test3@domain.com", LocalDate.of(2021,3, 11));
		User user8 = new User("Test4", "Test4@domain.com", LocalDate.of(2021, 4,12));
		User user9 = new User("Test5", "Test5@domain.com", LocalDate.of(2021, 5,22));
		User user10 = new User("Test6", "Test6@domain.com", LocalDate.of(2021,8,3));
		User user11 = new User("Test7", "Test7@domain.com", LocalDate.of(2021,1,12));
		User user12 = new User("Test8", "Test8@domain.com", LocalDate.of(2021, 2, 2));
